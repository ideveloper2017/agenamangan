...
<head>
    ...
    <link rel="stylesheet" href="assetsapp/bundles/jquery-selectric/selectric.css">
    <!-- Template CSS -->
                        ...
                        <div class="card-body">
                            <form action="{{route('create_user')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name_a">
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input id="email" type="email" class="form-control" name="email_a">
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                                <div class="row">
...
<!-- JS Libraies -->
<script src="assetsapp/bundles/jquery-pwstrength/jquery.pwstrength.min.js"></script>
<script src="assetsapp/bundles/jquery-selectric/jquery.selectric.min.js"></script>
<!-- Page Specific JS File -->
<script src="assetsapp/js/page/auth-register.js"></script>
<!-- Template JS File -->
